...
ScrollView {
    ...
    property string quizName:    "locks_quiz"
    property string lessonSource:"LocksPage.qml"
    ...
    Column {
        ...
        Rectangle {
            ...
            color: Qt.rgba(255,255,255,0.03); border.color: "#f59e0b"; border.width: 1
            Column { anchors.centerIn: parent; spacing: 5
                Text { text: "LOCKS  QUIZ"; color: "#f59e0b"
            ...
            Column { id: q1
                ...
                Text { text: "1.  Thread A holds lock_X, tries lock_Y; Thread B holds lock_Y, tries lock_X. This is ___."; color: "white"; font.pixelSize: 13
                    font.family: "Segoe UI"; width: parent.width; wrapMode: Text.WordWrap; lineHeight: 1.45 }
                Repeater { model: ["Race condition", "Deadlock", "Livelock", "Priority inversion"]
                    delegate: Rectangle {
            ...
            Column{id:q2
                ...
                width:parent.width;spacing:8
                Rectangle{width:parent.width;height:1;color:Qt.rgba(255,255,255,0.07)}
                Text{text:"2.  Match each lock concept to its description:";color:"white";font.pixelSize:13;font.family:"Segoe UI"
                ...
                Rectangle{width:q2.width;radius:10
                    ...
                    Column{id:dc2;anchors.top:parent.top;anchors.left:parent.left
                        ...
                        Text{text:"A.  Frees lock and wakes up waiters";color:Qt.rgba(255,255,255,0.68);font.pixelSize:11;font.family:"Segoe UI";width:parent.width;wrapMode:Text.WordWrap}
                        Text{text:"B.  Busy-waits (spin) until lock is free";color:Qt.rgba(255,255,255,0.68);font.pixelSize:11;font.family:"Segoe UI";width:parent.width;wrapMode:Text.WordWrap}
                        Text{text:"C.  Atomically claims the lock";color:Qt.rgba(255,255,255,0.68);font.pixelSize:11;font.family:"Segoe UI";width:parent.width;wrapMode:Text.WordWrap}
                        Text{text:"D.  Calls sleep() while waiting";color:Qt.rgba(255,255,255,0.68);font.pixelSize:11;font.family:"Segoe UI";width:parent.width;wrapMode:Text.WordWrap}
                    }}
                Column{width:q2.width;spacing:6
                    ...
                    Rectangle{width:q2.width;height:48;radius:8
                        ...
                        Text{anchors.left:parent.left;anchors.leftMargin:12;anchors.verticalCenter:parent.verticalCenter
                            width:100;text:"spinlock";color:"white";font.pixelSize:12;font.bold:true
                    ...
                    Rectangle{width:q2.width;height:48;radius:8
                        ...
                        border.color:Qt.rgba(255,255,255,0.08);border.width:1
                        Text{anchors.left:parent.left;anchors.leftMargin:12;anchors.verticalCenter:parent.verticalCenter
                            width:100;text:"sleeplock";color:"white";font.pixelSize:12;font.bold:true
                            font.family:"Segoe UI";elide:Text.ElideRight}
                        Row{anchors.right:parent.right;anchors.rightMargin:10;anchors.verticalCenter:parent.verticalCenter
                            spacing:8
                    ...
                    Rectangle{width:q2.width;height:48;radius:8
                        ...
                        border.color:Qt.rgba(255,255,255,0.08);border.width:1
                        Text{anchors.left:parent.left;anchors.leftMargin:12;anchors.verticalCenter:parent.verticalCenter
                            width:100;text:"acquire()";color:"white";font.pixelSize:12;font.bold:true
                            font.family:"Segoe UI";elide:Text.ElideRight}
                        Row{anchors.right:parent.right;anchors.rightMargin:10;anchors.verticalCenter:parent.verticalCenter
                            spacing:8
                    ...
                    Rectangle{width:q2.width;height:48;radius:8
                        ...
                        border.color:Qt.rgba(255,255,255,0.08);border.width:1
                        Text{anchors.left:parent.left;anchors.leftMargin:12;anchors.verticalCenter:parent.verticalCenter
                            width:100;text:"release()";color:"white";font.pixelSize:12;font.bold:true
                            font.family:"Segoe UI";elide:Text.ElideRight}
                        Row{anchors.right:parent.right;anchors.rightMargin:10;anchors.verticalCenter:parent.verticalCenter
                            spacing:8
            ...
            Column { id: q3
                ...
                width: parent.width; spacing: 8
                Rectangle { width: parent.width; height: 1; color: Qt.rgba(255,255,255,0.07) }
                Text { text: "3.  Acquiring locks in a consistent global order prevents deadlock."; color: "white"; font.pixelSize: 13
                    font.family: "Segoe UI"; width: parent.width; wrapMode: Text.WordWrap; lineHeight: 1.45 }
            ...
            Column { id: q4
                ...
                property bool submitted: scrollRoot.showResults
                property bool isCorrect: r0===3 && r1===4 && r2===1 && r3===2
                property bool answered: r0>0 && r1>0 && r2>0 && r3>0
                width: parent.width; spacing: 8
                Rectangle { width: parent.width; height: 1; color: Qt.rgba(255,255,255,0.07) }
                Text { text: "4.  Click the acquire() steps in order (first → last):"; color: "white"; font.pixelSize: 13
                    font.family: "Segoe UI"; width: parent.width; wrapMode: Text.WordWrap; lineHeight: 1.45 }
                ...
                Rectangle { width: q4.width; height: 52; radius: 10
                    ...
                    Text { anchors.left: parent.left; anchors.leftMargin: 50
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        text: "Set lock->locked=1 atomically (amoswap)"; color: "white"; font.pixelSize: 12; font.family: "Segoe UI"; wrapMode: Text.WordWrap }
                ...
                Rectangle { width: q4.width; height: 52; radius: 10
                    color: { if(!q4.submitted)return q4.r1>0?Qt.rgba(75,42,192,0.28):Qt.rgba(255,255,255,0.05)
                        if(q4.r1===4)return Qt.rgba(16,185,129,0.22)
                    ...
                    Text { anchors.left: parent.left; anchors.leftMargin: 50
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        text: "Record caller for deadlock debug"; color: "white"; font.pixelSize: 12; font.family: "Segoe UI"; wrapMode: Text.WordWrap }
                    Text { id: ht41; anchors.right: parent.right; anchors.rightMargin: 10
                        anchors.verticalCenter: parent.verticalCenter
                        visible: q4.submitted && q4.r1 !== 4
                ...
                Rectangle { width: q4.width; height: 52; radius: 10
                    ...
                    Text { anchors.left: parent.left; anchors.leftMargin: 50
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        text: "Disable interrupts via push_off()"; color: "white"; font.pixelSize: 12; font.family: "Segoe UI"; wrapMode: Text.WordWrap }
                ...
                Rectangle { width: q4.width; height: 52; radius: 10
                    ...
                    Text { anchors.left: parent.left; anchors.leftMargin: 50
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        text: "Spin-loop until lock->locked is 0"; color: "white"; font.pixelSize: 12; font.family: "Segoe UI"; wrapMode: Text.WordWrap }
            ...
            Column { id: q5
                ...
                width: parent.width; spacing: 8
                Rectangle { width: parent.width; height: 1; color: Qt.rgba(255,255,255,0.07) }
                Text { text: "5.  You can safely call sleep() while holding a spinlock in xv6."; color: "white"; font.pixelSize: 13
                    font.family: "Segoe UI"; width: parent.width; wrapMode: Text.WordWrap; lineHeight: 1.45 }
                Row { spacing: 14; width: parent.width
                    Repeater { model: ["True","False"]
                        delegate: Rectangle {
        ...
        Rectangle {
            ...
            Text { anchors.centerIn: parent
                text: "←   LOCKS  (Back to Lesson)"
                color: "#f59e0b"; font.bold: true; font.pixelSize: 13; font.family: "Segoe UI" }
