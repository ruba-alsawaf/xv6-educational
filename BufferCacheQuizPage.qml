...
ScrollView {
    ...
    property string quizName:    "buf_cache_quiz"
    property string lessonSource:"BufferCachePage.qml"
    ...
    Column {
        ...
        Rectangle {
            ...
            color: Qt.rgba(255,255,255,0.03); border.color: "#22d3ee"; border.width: 1
            Column { anchors.centerIn: parent; spacing: 5
                Text { text: "BUFFER CACHE  QUIZ"; color: "#22d3ee"
            ...
            Column { id: q1
                ...
                Text { text: "1.  bread(1,42): block 42 is in cache with refcnt=2. xv6 ___."; color: "white"; font.pixelSize: 13
                    font.family: "Segoe UI"; width: parent.width; wrapMode: Text.WordWrap; lineHeight: 1.45 }
                Repeater { model: ["Reads disk to refresh", "Returns cached buffer — no disk I/O", "Waits for refcnt to drop to 0", "Evicts and re-reads"]
                    delegate: Rectangle {
            ...
            Column{id:q2
                ...
                width:parent.width;spacing:8
                Rectangle{width:parent.width;height:1;color:Qt.rgba(255,255,255,0.07)}
                Text{text:"2.  Match each buffer cache function to its role:";color:"white";font.pixelSize:13;font.family:"Segoe UI"
                ...
                Rectangle{width:q2.width;radius:10
                    ...
                    Column{id:dc2;anchors.top:parent.top;anchors.left:parent.left
                        ...
                        Text{text:"A.  Global buffer pool (30 slots)";color:Qt.rgba(255,255,255,0.68);font.pixelSize:11;font.family:"Segoe UI";width:parent.width;wrapMode:Text.WordWrap}
                        Text{text:"B.  Reads from cache or disk; returns locked buf";color:Qt.rgba(255,255,255,0.68);font.pixelSize:11;font.family:"Segoe UI";width:parent.width;wrapMode:Text.WordWrap}
                        Text{text:"C.  Releases buffer and decrements refcnt";color:Qt.rgba(255,255,255,0.68);font.pixelSize:11;font.family:"Segoe UI";width:parent.width;wrapMode:Text.WordWrap}
                        Text{text:"D.  Writes dirty buffer to disk";color:Qt.rgba(255,255,255,0.68);font.pixelSize:11;font.family:"Segoe UI";width:parent.width;wrapMode:Text.WordWrap}
                    }}
                Column{width:q2.width;spacing:6
                    ...
                    Rectangle{width:q2.width;height:48;radius:8
                        ...
                        Text{anchors.left:parent.left;anchors.leftMargin:12;anchors.verticalCenter:parent.verticalCenter
                            width:100;text:"bread()";color:"white";font.pixelSize:12;font.bold:true
                    ...
                    Rectangle{width:q2.width;height:48;radius:8
                        ...
                        border.color:Qt.rgba(255,255,255,0.08);border.width:1
                        Text{anchors.left:parent.left;anchors.leftMargin:12;anchors.verticalCenter:parent.verticalCenter
                            width:100;text:"brelse()";color:"white";font.pixelSize:12;font.bold:true
                            font.family:"Segoe UI";elide:Text.ElideRight}
                        Row{anchors.right:parent.right;anchors.rightMargin:10;anchors.verticalCenter:parent.verticalCenter
                            spacing:8
                    ...
                    Rectangle{width:q2.width;height:48;radius:8
                        ...
                        border.color:Qt.rgba(255,255,255,0.08);border.width:1
                        Text{anchors.left:parent.left;anchors.leftMargin:12;anchors.verticalCenter:parent.verticalCenter
                            width:100;text:"bwrite()";color:"white";font.pixelSize:12;font.bold:true
                            font.family:"Segoe UI";elide:Text.ElideRight}
                        Row{anchors.right:parent.right;anchors.rightMargin:10;anchors.verticalCenter:parent.verticalCenter
                            spacing:8
                    ...
                    Rectangle{width:q2.width;height:48;radius:8
                        ...
                        border.color:Qt.rgba(255,255,255,0.08);border.width:1
                        Text{anchors.left:parent.left;anchors.leftMargin:12;anchors.verticalCenter:parent.verticalCenter
                            width:100;text:"bcache";color:"white";font.pixelSize:12;font.bold:true
                            font.family:"Segoe UI";elide:Text.ElideRight}
                        Row{anchors.right:parent.right;anchors.rightMargin:10;anchors.verticalCenter:parent.verticalCenter
                            spacing:8
            ...
            Column { id: q3
                ...
                width: parent.width; spacing: 8
                Rectangle { width: parent.width; height: 1; color: Qt.rgba(255,255,255,0.07) }
                Text { text: "3.  Two threads can simultaneously hold the same buffer (same dev+blockno)."; color: "white"; font.pixelSize: 13
                    font.family: "Segoe UI"; width: parent.width; wrapMode: Text.WordWrap; lineHeight: 1.45 }
            ...
            Column { id: q4
                ...
                width: parent.width; spacing: 8
                Rectangle { width: parent.width; height: 1; color: Qt.rgba(255,255,255,0.07) }
                Text { text: "4.  Click the bread() steps in order (first → last):"; color: "white"; font.pixelSize: 13
                    font.family: "Segoe UI"; width: parent.width; wrapMode: Text.WordWrap; lineHeight: 1.45 }
                ...
                Rectangle { width: q4.width; height: 52; radius: 10
                    ...
                    Text { anchors.left: parent.left; anchors.leftMargin: 50
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        text: "Return the locked buffer to caller"; color: "white"; font.pixelSize: 12; font.family: "Segoe UI"; wrapMode: Text.WordWrap }
                ...
                Rectangle { width: q4.width; height: 52; radius: 10
                    ...
                    Text { anchors.left: parent.left; anchors.leftMargin: 50
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        text: "Search bcache for matching dev+blockno"; color: "white"; font.pixelSize: 12; font.family: "Segoe UI"; wrapMode: Text.WordWrap }
                ...
                Rectangle { width: q4.width; height: 52; radius: 10
                    ...
                    Text { anchors.left: parent.left; anchors.leftMargin: 50
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        text: "If cache miss: read block from disk"; color: "white"; font.pixelSize: 12; font.family: "Segoe UI"; wrapMode: Text.WordWrap }
                ...
                Rectangle { width: q4.width; height: 52; radius: 10
                    ...
                    Text { anchors.left: parent.left; anchors.leftMargin: 50
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        text: "Acquire the buffer's sleeplock"; color: "white"; font.pixelSize: 12; font.family: "Segoe UI"; wrapMode: Text.WordWrap }
            ...
            Column { id: q5
                ...
                width: parent.width; spacing: 8
                Rectangle { width: parent.width; height: 1; color: Qt.rgba(255,255,255,0.07) }
                Text { text: "5.  All 30 buffer slots are held. A new bread() call will ___."; color: "white"; font.pixelSize: 13
                    font.family: "Segoe UI"; width: parent.width; wrapMode: Text.WordWrap; lineHeight: 1.45 }
                Repeater { model: ["Panic", "Allocate a 31st slot", "Sleep until brelse() frees a slot", "Return NULL"]
                    delegate: Rectangle {
        ...
        Rectangle {
            ...
            Text { anchors.centerIn: parent
                text: "←   BUFFER CACHE  (Back to Lesson)"
                color: "#22d3ee"; font.bold: true; font.pixelSize: 13; font.family: "Segoe UI" }
