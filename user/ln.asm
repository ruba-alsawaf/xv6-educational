...
main(int argc, char *argv[])
{
  ...
  14:	91058593          	addi	a1,a1,-1776 # 920 <malloc+0xfe>
  18:	4509                	li	a0,2
  ...
  42:	8fa58593          	addi	a1,a1,-1798 # 938 <malloc+0x116>
  46:	4509                	li	a0,2
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 408:	55480813          	addi	a6,a6,1364 # 958 <digits>
 40c:	88ba                	mv	a7,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 62c:	330b8b93          	addi	s7,s7,816 # 958 <digits>
 ...
 68a:	2ca48493          	addi	s1,s1,714 # 950 <malloc+0x12e>
        for(; *s; s++)
