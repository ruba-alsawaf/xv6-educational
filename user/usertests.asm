...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5486:	00005797          	auipc	a5,0x5
    548a:	00a7b783          	ld	a5,10(a5) # a490 <freep>
    ...
    5496:	00e6ea63          	bltu	a3,a4,54aa <free+0x30>
{
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    54d4:	00005717          	auipc	a4,0x5
    54d8:	faf73e23          	sd	a5,-68(a4) # a490 <freep>
}
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    551c:	894e                	mv	s2,s3
  if((prevp = freep) == 0){
    551e:	00005517          	auipc	a0,0x5
    5522:	f7253503          	ld	a0,-142(a0) # a490 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    554a:	00005497          	auipc	s1,0x5
    554e:	f4648493          	addi	s1,s1,-186 # a490 <freep>
  if(p == SBRK_ERROR)
    5552:	5afd                	li	s5,-1
    ...
    base.s.ptr = freep = prevp = &base;
    555e:	0000b797          	auipc	a5,0xb
    5562:	75a78793          	addi	a5,a5,1882 # 10cb8 <base>
    5566:	00005717          	auipc	a4,0x5
    556a:	f2f73523          	sd	a5,-214(a4) # a490 <freep>
  ...
  if(p == SBRK_ERROR)
    ...
    55cc:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    55d0:	00005717          	auipc	a4,0x5
    55d4:	eca73023          	sd	a0,-320(a4) # a490 <freep>
      return (void*)(p + 1);
