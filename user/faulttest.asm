...
main(void)
{
  ...
  28:	93450513          	addi	a0,a0,-1740 # 958 <malloc+0x146>
  2c:	732000ef          	jal	75e <printf>
  p[0] = 1;
  30:	4785                	li	a5,1
  ...
  3a:	94250513          	addi	a0,a0,-1726 # 978 <malloc+0x166>
  3e:	720000ef          	jal	75e <printf>
  p[4096] = 2;
  42:	6785                	lui	a5,0x1
  ...
  50:	95450513          	addi	a0,a0,-1708 # 9a0 <malloc+0x18e>
  54:	70a000ef          	jal	75e <printf>
  exit(0);
  58:	4501                	li	a0,0
  ...
  64:	8d850513          	addi	a0,a0,-1832 # 938 <malloc+0x126>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 412:	5b250513          	addi	a0,a0,1458 # 9c0 <digits>
 416:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6a8:	31cb8b93          	addi	s7,s7,796 # 9c0 <digits>
 ...
 70a:	2b290913          	addi	s2,s2,690 # 9b8 <malloc+0x1a6>
        for(; *s; s++)
