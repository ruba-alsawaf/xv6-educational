...
main(int argc, char *argv[])
{
  ...
  38:	92cb0b13          	addi	s6,s6,-1748 # 960 <malloc+0x100>
  ...
  6c:	90058593          	addi	a1,a1,-1792 # 968 <malloc+0x108>
  70:	8532                	mv	a0,a2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 66a:	312b8b93          	addi	s7,s7,786 # 978 <digits>
 ...
 6c8:	2ac48493          	addi	s1,s1,684 # 970 <malloc+0x110>
        for(; *s; s++)
