...
forktest(void)
{
  ...
  36:	40e50513          	addi	a0,a0,1038 # 440 <memread+0xe>
  ...
  58:	43c50513          	addi	a0,a0,1084 # 490 <memread+0x5e>
  ...
  6e:	3e650513          	addi	a0,a0,998 # 450 <memread+0x1e>
  ...
  80:	3ec50513          	addi	a0,a0,1004 # 468 <memread+0x36>
  ...
  b0:	3d450513          	addi	a0,a0,980 # 480 <memread+0x4e>
