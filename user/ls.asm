...
ls(char *path)
{
  ...
  f4:	a7050513          	addi	a0,a0,-1424 # b60 <malloc+0x124>
  f8:	08d000ef          	jal	984 <printf>
      }
 ...
 11e:	a1658593          	addi	a1,a1,-1514 # b30 <malloc+0xf4>
 122:	4509                	li	a0,2
 124:	037000ef          	jal	95a <fprintf>
    return;
 128:	bff9                	j	106 <ls+0x6e>
    fprintf(2, "ls: cannot stat %s\n", path);
 12a:	864a                	mv	a2,s2
 12c:	00001597          	auipc	a1,0x1
 130:	a1c58593          	addi	a1,a1,-1508 # b48 <malloc+0x10c>
 134:	4509                	li	a0,2
 136:	025000ef          	jal	95a <fprintf>
    close(fd);
 13a:	8526                	mv	a0,s1
 ...
 15a:	a1a50513          	addi	a0,a0,-1510 # b70 <malloc+0x134>
 15e:	027000ef          	jal	984 <printf>
      break;
 ...
 1a0:	9ac50513          	addi	a0,a0,-1620 # b48 <malloc+0x10c>
 1a4:	7e0000ef          	jal	984 <printf>
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
 1a8:	4641                	li	a2,16
 ...
 1fa:	96a50513          	addi	a0,a0,-1686 # b60 <malloc+0x124>
 1fe:	786000ef          	jal	984 <printf>
...
main(int argc, char *argv[])
{
 ...
 24a:	94250513          	addi	a0,a0,-1726 # b88 <malloc+0x14c>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 608:	892a                	mv	s2,a0
  ...
  neg = 0;
  if(sgn && xx < 0){
 60a:	c6d1                	beqz	a3,696 <printint+0x9a>
 60c:	0805d563          	bgez	a1,696 <printint+0x9a>
    neg = 1;
    x = -xx;
 ...
 622:	57a80813          	addi	a6,a6,1402 # b98 <digits>
 626:	88ba                	mv	a7,a4
 ...
 644:	fec7f1e3          	bgeu	a5,a2,626 <printint+0x2a>
  if(neg)
 648:	00030c63          	beqz	t1,660 <printint+0x64>
    buf[i++] = '-';
 64c:	fd050793          	addi	a5,a0,-48
 650:	00878533          	add	a0,a5,s0
 654:	02d00793          	li	a5,45
 658:	fef50423          	sb	a5,-24(a0)
 65c:	0028871b          	addiw	a4,a7,2

  while(--i >= 0)
 660:	02e05563          	blez	a4,68a <printint+0x8e>
 ...
 67c:	854a                	mv	a0,s2
 67e:	f61ff0ef          	jal	5de <putc>
  while(--i >= 0)
 682:	14fd                	addi	s1,s1,-1
 684:	ff349ae3          	bne	s1,s3,678 <printint+0x7c>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6a8:	22048363          	beqz	s1,8ce <vprintf+0x234>
 ...
 6ec:	1c048a63          	beqz	s1,8c0 <vprintf+0x226>
    c0 = fmt[i] & 0xff;
 ...
 704:	0016c603          	lbu	a2,1(a3)
      if(c1) c2 = fmt[i+2] & 0xff;
 708:	1c060863          	beqz	a2,8d8 <vprintf+0x23e>
      if(c0 == 'd'){
 ...
 766:	18051363          	bnez	a0,8ec <vprintf+0x252>
 76a:	18070163          	beqz	a4,8ec <vprintf+0x252>
        printint(fd, va_arg(ap, uint64), 10, 1);
 ...
 870:	855a                	mv	a0,s6
 872:	d6dff0ef          	jal	5de <putc>
 876:	8ba6                	mv	s7,s1
      state = 0;
 878:	4981                	li	s3,0
 87a:	b595                	j	6de <vprintf+0x44>
        if((s = va_arg(ap, char*)) == 0)
 87c:	008b8993          	addi	s3,s7,8
 880:	000bb483          	ld	s1,0(s7)
 884:	cc91                	beqz	s1,8a0 <vprintf+0x206>
        for(; *s; s++)
 886:	0004c583          	lbu	a1,0(s1)
 88a:	c985                	beqz	a1,8ba <vprintf+0x220>
          putc(fd, *s);
 88c:	855a                	mv	a0,s6
 88e:	d51ff0ef          	jal	5de <putc>
        for(; *s; s++)
 892:	0485                	addi	s1,s1,1
 894:	0004c583          	lbu	a1,0(s1)
 898:	f9f5                	bnez	a1,88c <vprintf+0x1f2>
        if((s = va_arg(ap, char*)) == 0)
 89a:	8bce                	mv	s7,s3
      state = 0;
 89c:	4981                	li	s3,0
 89e:	b581                	j	6de <vprintf+0x44>
          s = "(null)";
 8a0:	00000497          	auipc	s1,0x0
 8a4:	2f048493          	addi	s1,s1,752 # b90 <malloc+0x154>
        for(; *s; s++)
 8a8:	02800593          	li	a1,40
 8ac:	b7c5                	j	88c <vprintf+0x1f2>
        putc(fd, '%');
 8ae:	85be                	mv	a1,a5
 8b0:	855a                	mv	a0,s6
 8b2:	d2dff0ef          	jal	5de <putc>
      state = 0;
 8b6:	4981                	li	s3,0
 8b8:	b51d                	j	6de <vprintf+0x44>
        if((s = va_arg(ap, char*)) == 0)
 8ba:	8bce                	mv	s7,s3
      state = 0;
 8bc:	4981                	li	s3,0
 8be:	b505                	j	6de <vprintf+0x44>
 ...
 8d6:	8082                	ret
      if(c0 == 'd'){
 8d8:	06400713          	li	a4,100
 8dc:	e4e78fe3          	beq	a5,a4,73a <vprintf+0xa0>
      } else if(c0 == 'l' && c1 == 'd'){
 8e0:	f9478693          	addi	a3,a5,-108
 8e4:	0016b693          	seqz	a3,a3
      c1 = c2 = 0;
 8e8:	85b2                	mv	a1,a2
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 8ea:	4701                	li	a4,0
      } else if(c0 == 'u'){
 8ec:	07500513          	li	a0,117
 8f0:	e8a78ce3          	beq	a5,a0,788 <vprintf+0xee>
      } else if(c0 == 'l' && c1 == 'u'){
 8f4:	f8b60513          	addi	a0,a2,-117
 8f8:	e119                	bnez	a0,8fe <vprintf+0x264>
 8fa:	ea0693e3          	bnez	a3,7a0 <vprintf+0x106>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 8fe:	f8b58513          	addi	a0,a1,-117
 902:	e119                	bnez	a0,908 <vprintf+0x26e>
 904:	ea071be3          	bnez	a4,7ba <vprintf+0x120>
      } else if(c0 == 'x'){
 908:	07800513          	li	a0,120
 90c:	eca784e3          	beq	a5,a0,7d4 <vprintf+0x13a>
      } else if(c0 == 'l' && c1 == 'x'){
 910:	f8860613          	addi	a2,a2,-120
 914:	e219                	bnez	a2,91a <vprintf+0x280>
 916:	ec069be3          	bnez	a3,7ec <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
 91a:	f8858593          	addi	a1,a1,-120
 91e:	e199                	bnez	a1,924 <vprintf+0x28a>
 920:	ee0713e3          	bnez	a4,806 <vprintf+0x16c>
      } else if(c0 == 'p'){
 924:	07000713          	li	a4,112
 928:	eee78ce3          	beq	a5,a4,820 <vprintf+0x186>
      } else if(c0 == 'c'){
 92c:	06300713          	li	a4,99
 930:	f2e78ce3          	beq	a5,a4,868 <vprintf+0x1ce>
      } else if(c0 == 's'){
 934:	07300713          	li	a4,115
 938:	f4e782e3          	beq	a5,a4,87c <vprintf+0x1e2>
      } else if(c0 == '%'){
 93c:	02500713          	li	a4,37
 940:	f6e787e3          	beq	a5,a4,8ae <vprintf+0x214>
        putc(fd, '%');
 944:	02500593          	li	a1,37
 948:	855a                	mv	a0,s6
 94a:	c95ff0ef          	jal	5de <putc>
        putc(fd, c0);
 94e:	85a6                	mv	a1,s1
 950:	855a                	mv	a0,s6
 952:	c8dff0ef          	jal	5de <putc>
      state = 0;
 956:	4981                	li	s3,0
 958:	b359                	j	6de <vprintf+0x44>

000000000000095a <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
 95a:	715d                	addi	sp,sp,-80
 95c:	ec06                	sd	ra,24(sp)
 95e:	e822                	sd	s0,16(sp)
 960:	1000                	addi	s0,sp,32
 962:	e010                	sd	a2,0(s0)
 964:	e414                	sd	a3,8(s0)
 966:	e818                	sd	a4,16(s0)
 968:	ec1c                	sd	a5,24(s0)
 96a:	03043023          	sd	a6,32(s0)
 96e:	03143423          	sd	a7,40(s0)
  va_list ap;
 ...
 974:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
 978:	d23ff0ef          	jal	69a <vprintf>
}
 97c:	60e2                	ld	ra,24(sp)
 97e:	6442                	ld	s0,16(sp)
 980:	6161                	addi	sp,sp,80
 982:	8082                	ret

0000000000000984 <printf>:

void
printf(const char *fmt, ...)
{
 984:	711d                	addi	sp,sp,-96
 986:	ec06                	sd	ra,24(sp)
 988:	e822                	sd	s0,16(sp)
 98a:	1000                	addi	s0,sp,32
 98c:	e40c                	sd	a1,8(s0)
 98e:	e810                	sd	a2,16(s0)
 990:	ec14                	sd	a3,24(s0)
 992:	f018                	sd	a4,32(s0)
 994:	f41c                	sd	a5,40(s0)
 996:	03043823          	sd	a6,48(s0)
 99a:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
 99e:	00840613          	addi	a2,s0,8
 9a2:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
 9a6:	85aa                	mv	a1,a0
 9a8:	4505                	li	a0,1
 9aa:	cf1ff0ef          	jal	69a <vprintf>
}
...
free(void *ap)
{
 ...
 9ca:	a039                	j	9d8 <free+0x22>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 9cc:	6398                	ld	a4,0(a5)
 9ce:	00e7e463          	bltu	a5,a4,9d6 <free+0x20>
 9d2:	00e6ea63          	bltu	a3,a4,9e6 <free+0x30>
{
 9d6:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 9d8:	fed7fae3          	bgeu	a5,a3,9cc <free+0x16>
 9dc:	6398                	ld	a4,0(a5)
 9de:	00e6e463          	bltu	a3,a4,9e6 <free+0x30>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 9e2:	fee7eae3          	bltu	a5,a4,9d6 <free+0x20>
      break;
 ...
 9f6:	02e60563          	beq	a2,a4,a20 <free+0x6a>
 ...
 a0a:	02e68263          	beq	a3,a4,a2e <free+0x78>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
 a0e:	e394                	sd	a3,0(a5)
  } else
...
malloc(uint nbytes)
{
 ...
 a48:	02051993          	slli	s3,a0,0x20
 a4c:	0209d993          	srli	s3,s3,0x20
 a50:	09bd                	addi	s3,s3,15
 a52:	0049d993          	srli	s3,s3,0x4
 a56:	2985                	addiw	s3,s3,1
 a58:	894e                	mv	s2,s3
  if((prevp = freep) == 0){
 a5a:	00000517          	auipc	a0,0x0
 a5e:	5a653503          	ld	a0,1446(a0) # 1000 <freep>
 a62:	c905                	beqz	a0,a92 <malloc+0x56>
 ...
 a64:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 a66:	4798                	lw	a4,8(a5)
 a68:	09377663          	bgeu	a4,s3,af4 <malloc+0xb8>
 ...
 a74:	8a4e                	mv	s4,s3
 a76:	6705                	lui	a4,0x1
 a78:	00e9f363          	bgeu	s3,a4,a7e <malloc+0x42>
 a7c:	6a05                	lui	s4,0x1
 ...
 a82:	004a1a1b          	slliw	s4,s4,0x4
    ...
    if(p == freep)
 a86:	00000497          	auipc	s1,0x0
 a8a:	57a48493          	addi	s1,s1,1402 # 1000 <freep>
  if(p == SBRK_ERROR)
 a8e:	5afd                	li	s5,-1
 a90:	a83d                	j	ace <malloc+0x92>
 ...
 aac:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
 ab0:	b7d1                	j	a74 <malloc+0x38>
        prevp->s.ptr = p->s.ptr;
 ab2:	6398                	ld	a4,0(a5)
 ab4:	e118                	sd	a4,0(a0)
 ab6:	a899                	j	b0c <malloc+0xd0>
  hp->s.size = nu;
 ab8:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
 abc:	0541                	addi	a0,a0,16
 abe:	ef9ff0ef          	jal	9b6 <free>
  return freep;
 ac2:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
 ac4:	c125                	beqz	a0,b24 <malloc+0xe8>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ac6:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 ac8:	4798                	lw	a4,8(a5)
 aca:	03277163          	bgeu	a4,s2,aec <malloc+0xb0>
    if(p == freep)
 ace:	6098                	ld	a4,0(s1)
 ad0:	853e                	mv	a0,a5
 ad2:	fef71ae3          	bne	a4,a5,ac6 <malloc+0x8a>
  p = sbrk(nu * sizeof(Header));
 ad6:	8552                	mv	a0,s4
 ad8:	a03ff0ef          	jal	4da <sbrk>
  if(p == SBRK_ERROR)
 adc:	fd551ee3          	bne	a0,s5,ab8 <malloc+0x7c>
        return 0;
 ae0:	4501                	li	a0,0
 ...
 ae6:	6aa2                	ld	s5,8(sp)
 ae8:	6b02                	ld	s6,0(sp)
 aea:	a03d                	j	b18 <malloc+0xdc>
 aec:	74a2                	ld	s1,40(sp)
 aee:	6a42                	ld	s4,16(sp)
 af0:	6aa2                	ld	s5,8(sp)
 af2:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
 af4:	fae90fe3          	beq	s2,a4,ab2 <malloc+0x76>
        p->s.size -= nunits;
