...
wc(int fd, char *name)
{
  ...
  40:	a04a0a13          	addi	s4,s4,-1532 # a40 <malloc+0x100>
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  a2:	9c250513          	addi	a0,a0,-1598 # a60 <malloc+0x120>
  a6:	7e2000ef          	jal	888 <printf>
}
  ...
  cc:	98850513          	addi	a0,a0,-1656 # a50 <malloc+0x110>
  d0:	7b8000ef          	jal	888 <printf>
    exit(1);
  d4:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
 ...
 136:	91658593          	addi	a1,a1,-1770 # a48 <malloc+0x108>
 13a:	4501                	li	a0,0
 ...
 14e:	92650513          	addi	a0,a0,-1754 # a70 <malloc+0x130>
 152:	736000ef          	jal	888 <printf>
      exit(1);
 156:	4505                	li	a0,1
