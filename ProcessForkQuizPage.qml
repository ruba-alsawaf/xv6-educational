...
ScrollView {
    ...
    property string quizName:    "proc_fork_quiz"
    property string lessonSource:"ProcessForkPage.qml"
    ...
    Column {
        ...
        Rectangle {
            ...
            color: Qt.rgba(255,255,255,0.03); border.color: "#a78bfa"; border.width: 1
            Column { anchors.centerIn: parent; spacing: 5
                Text { text: "PROCESSES & FORK  QUIZ"; color: "#a78bfa"
            ...
            Column { id: q1
                ...
                Text { text: "1.  fork() returns 0 to the parent process."; color: "white"; font.pixelSize: 13
            ...
            Column{id:q2
                ...
                width:parent.width;spacing:8
                Rectangle{width:parent.width;height:1;color:Qt.rgba(255,255,255,0.07)}
                Text{text:"2.  Match each system call to its primary effect:";color:"white";font.pixelSize:13;font.family:"Segoe UI"
                ...
                Rectangle{width:q2.width;radius:10
                    ...
                    Column{id:dc2;anchors.top:parent.top;anchors.left:parent.left
                        ...
                        Text{text:"A.  Terminates the calling process";color:Qt.rgba(255,255,255,0.68);font.pixelSize:11;font.family:"Segoe UI";width:parent.width;wrapMode:Text.WordWrap}
                        Text{text:"B.  Duplicates the current process";color:Qt.rgba(255,255,255,0.68);font.pixelSize:11;font.family:"Segoe UI";width:parent.width;wrapMode:Text.WordWrap}
                        Text{text:"C.  Replaces the process image";color:Qt.rgba(255,255,255,0.68);font.pixelSize:11;font.family:"Segoe UI";width:parent.width;wrapMode:Text.WordWrap}
                        Text{text:"D.  Blocks until a child exits";color:Qt.rgba(255,255,255,0.68);font.pixelSize:11;font.family:"Segoe UI";width:parent.width;wrapMode:Text.WordWrap}
                    }}
                Column{width:q2.width;spacing:6
                    ...
                    Rectangle{width:q2.width;height:48;radius:8
                        ...
                        Text{anchors.left:parent.left;anchors.leftMargin:12;anchors.verticalCenter:parent.verticalCenter
                            width:100;text:"fork()";color:"white";font.pixelSize:12;font.bold:true
                    ...
                    Rectangle{width:q2.width;height:48;radius:8
                        ...
                        border.color:Qt.rgba(255,255,255,0.08);border.width:1
                        Text{anchors.left:parent.left;anchors.leftMargin:12;anchors.verticalCenter:parent.verticalCenter
                            width:100;text:"exec()";color:"white";font.pixelSize:12;font.bold:true
                            font.family:"Segoe UI";elide:Text.ElideRight}
                        Row{anchors.right:parent.right;anchors.rightMargin:10;anchors.verticalCenter:parent.verticalCenter
                            spacing:8
                    ...
                    Rectangle{width:q2.width;height:48;radius:8
                        ...
                        border.color:Qt.rgba(255,255,255,0.08);border.width:1
                        Text{anchors.left:parent.left;anchors.leftMargin:12;anchors.verticalCenter:parent.verticalCenter
                            width:100;text:"wait()";color:"white";font.pixelSize:12;font.bold:true
                            font.family:"Segoe UI";elide:Text.ElideRight}
                        Row{anchors.right:parent.right;anchors.rightMargin:10;anchors.verticalCenter:parent.verticalCenter
                            spacing:8
                    ...
                    Rectangle{width:q2.width;height:48;radius:8
                        ...
                        border.color:Qt.rgba(255,255,255,0.08);border.width:1
                        Text{anchors.left:parent.left;anchors.leftMargin:12;anchors.verticalCenter:parent.verticalCenter
                            width:100;text:"exit()";color:"white";font.pixelSize:12;font.bold:true
                            font.family:"Segoe UI";elide:Text.ElideRight}
                        Row{anchors.right:parent.right;anchors.rightMargin:10;anchors.verticalCenter:parent.verticalCenter
                            spacing:8
            ...
            Column { id: q3
                ...
                width: parent.width; spacing: 8
                Rectangle { width: parent.width; height: 1; color: Qt.rgba(255,255,255,0.07) }
                Text { text: "3.  A shell runs 'ls'. What is the correct sequence?"; color: "white"; font.pixelSize: 13
                    font.family: "Segoe UI"; width: parent.width; wrapMode: Text.WordWrap; lineHeight: 1.45 }
                Repeater { model: ["exec() then fork()", "fork() then exec()", "wait() then fork()", "fork() then wait()"]
                    delegate: Rectangle {
            ...
            Column { id: q4
                ...
                width: parent.width; spacing: 8
                Rectangle { width: parent.width; height: 1; color: Qt.rgba(255,255,255,0.07) }
                Text { text: "4.  Click the fork + exec + wait steps in order (first → last):"; color: "white"; font.pixelSize: 13
                    font.family: "Segoe UI"; width: parent.width; wrapMode: Text.WordWrap; lineHeight: 1.45 }
                ...
                Rectangle { width: q4.width; height: 52; radius: 10
                    ...
                    Text { anchors.left: parent.left; anchors.leftMargin: 50
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        text: "parent calls wait()"; color: "white"; font.pixelSize: 12; font.family: "Segoe UI"; wrapMode: Text.WordWrap }
                ...
                Rectangle { width: q4.width; height: 52; radius: 10
                    ...
                    Text { anchors.left: parent.left; anchors.leftMargin: 50
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        text: "exec() replaces child image"; color: "white"; font.pixelSize: 12; font.family: "Segoe UI"; wrapMode: Text.WordWrap }
                ...
                Rectangle { width: q4.width; height: 52; radius: 10
                    ...
                    Text { anchors.left: parent.left; anchors.leftMargin: 50
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        text: "fork() creates the child"; color: "white"; font.pixelSize: 12; font.family: "Segoe UI"; wrapMode: Text.WordWrap }
                ...
                Rectangle { width: q4.width; height: 52; radius: 10
                    ...
                    Text { anchors.left: parent.left; anchors.leftMargin: 50
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        text: "child calls exec()"; color: "white"; font.pixelSize: 12; font.family: "Segoe UI"; wrapMode: Text.WordWrap }
            ...
            Column { id: q5
                ...
                width: parent.width; spacing: 8
                Rectangle { width: parent.width; height: 1; color: Qt.rgba(255,255,255,0.07) }
                Text { text: "5.  After fork(), parent and child share the same stack memory."; color: "white"; font.pixelSize: 13
                    font.family: "Segoe UI"; width: parent.width; wrapMode: Text.WordWrap; lineHeight: 1.45 }
                Row { spacing: 14; width: parent.width
                    Repeater { model: ["True","False"]
                        delegate: Rectangle {
        ...
        Rectangle {
            ...
            Text { anchors.centerIn: parent
                text: "←   PROCESSES & FORK  (Back to Lesson)"
                color: "#a78bfa"; font.bold: true; font.pixelSize: 13; font.family: "Segoe UI" }
