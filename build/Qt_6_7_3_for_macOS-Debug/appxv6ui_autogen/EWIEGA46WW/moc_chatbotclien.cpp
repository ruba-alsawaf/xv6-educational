/****************************************************************************
** Meta object code from reading C++ file 'chatbotclien.h'
**
...
#error "The header file 'chatbotclien.h' doesn't include <QObject>."
...
Q_CONSTINIT const QMetaObject ChatBotClient::staticMetaObject = { {
    ...
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSChatBotClientENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ChatBotClient, std::true_type>,
