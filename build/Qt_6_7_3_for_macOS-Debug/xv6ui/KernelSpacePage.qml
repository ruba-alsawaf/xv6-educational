...
ScrollView {
    ...
    Column {
        ...
        Row {
            ...
            Rectangle {
                ...
                Item {
                    ...
                    // عمود خارطة الذاكرة تم ضبط أحجامه بدقة ليظهر بالكامل
                    Column {
                        id: memoryStack
                    ...
                    // الـ Canvas لرسم السهم الرابط المتقطع الموجه بدقة
                    Canvas {
                        anchors.fill: parent
        ...
        // ==========================================
        // 3. EXPLANATION SECTION: صياغة مصلحة تمنع خروج النص وتدعم الالتفاف التلقائي مقروءة 100%
        // ==========================================
        Rectangle {
            width: parent.width
            height: 220 // زيادة الارتفاع ليتناسب مع التفاف النصوص الطويلة لأسفل براحة
