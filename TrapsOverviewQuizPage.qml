...
ScrollView {
    ...
    property string quizName:    "traps_quiz"
    property string lessonSource:"TrapsOverviewPage.qml"
    ...
    Column {
        ...
        Rectangle {
            ...
            color: Qt.rgba(255,255,255,0.03); border.color: "#f97316"; border.width: 1
            Column { anchors.centerIn: parent; spacing: 5
                Text { text: "TRAPS OVERVIEW  QUIZ"; color: "#f97316"
            ...
            Column { id: q1
                ...
                Text { text: "1.  A timer fires while in U-mode. What type of trap is this?"; color: "white"; font.pixelSize: 13
                    font.family: "Segoe UI"; width: parent.width; wrapMode: Text.WordWrap; lineHeight: 1.45 }
                Repeater { model: ["Exception", "System call", "Interrupt", "Software fault"]
                    delegate: Rectangle {
            ...
            Column{id:q2
                ...
                property bool submitted:scrollRoot.showResults
                property bool isCorrect:m0===2 && m1===1 && m2===3 && m3===0
                property bool answered:m0!==-1&&m1!==-1&&m2!==-1&&m3!==-1
                width:parent.width;spacing:8
                Rectangle{width:parent.width;height:1;color:Qt.rgba(255,255,255,0.07)}
                Text{text:"2.  Match each trap register to its role:";color:"white";font.pixelSize:13;font.family:"Segoe UI"
                ...
                Rectangle{width:q2.width;radius:10
                    ...
                    Column{id:dc2;anchors.top:parent.top;anchors.left:parent.left
                        ...
                        Text{text:"A.  Swapped with user SP; points to trapframe";color:Qt.rgba(255,255,255,0.68);font.pixelSize:11;font.family:"Segoe UI";width:parent.width;wrapMode:Text.WordWrap}
                        Text{text:"B.  PC saved when trap fired";color:Qt.rgba(255,255,255,0.68);font.pixelSize:11;font.family:"Segoe UI";width:parent.width;wrapMode:Text.WordWrap}
                        Text{text:"C.  Address CPU jumps to on trap";color:Qt.rgba(255,255,255,0.68);font.pixelSize:11;font.family:"Segoe UI";width:parent.width;wrapMode:Text.WordWrap}
                        Text{text:"D.  Reason the trap occurred";color:Qt.rgba(255,255,255,0.68);font.pixelSize:11;font.family:"Segoe UI";width:parent.width;wrapMode:Text.WordWrap}
                    }}
                Column{width:q2.width;spacing:6
                    ...
                    Rectangle{width:q2.width;height:48;radius:8
                        ...
                        border.color:Qt.rgba(255,255,255,0.08);border.width:1
                        Text{anchors.left:parent.left;anchors.leftMargin:12;anchors.verticalCenter:parent.verticalCenter
                            width:100;text:"sscratch";color:"white";font.pixelSize:12;font.bold:true
                            font.family:"Segoe UI";elide:Text.ElideRight}
                        Row{anchors.right:parent.right;anchors.rightMargin:10;anchors.verticalCenter:parent.verticalCenter
                            spacing:8
            ...
            Column { id: q3
                ...
                width: parent.width; spacing: 8
                Rectangle { width: parent.width; height: 1; color: Qt.rgba(255,255,255,0.07) }
                Text { text: "3.  All traps from user space in xv6 pass through the trampoline page."; color: "white"; font.pixelSize: 13
                    font.family: "Segoe UI"; width: parent.width; wrapMode: Text.WordWrap; lineHeight: 1.45 }
            ...
            Column { id: q4
                ...
                property bool submitted: scrollRoot.showResults
                property bool isCorrect: r0===3 && r1===2 && r2===4 && r3===1
                property bool answered: r0>0 && r1>0 && r2>0 && r3>0
                width: parent.width; spacing: 8
                Rectangle { width: parent.width; height: 1; color: Qt.rgba(255,255,255,0.07) }
                Text { text: "4.  Click the xv6 user-trap handling steps in order (first → last):"; color: "white"; font.pixelSize: 13
                    font.family: "Segoe UI"; width: parent.width; wrapMode: Text.WordWrap; lineHeight: 1.45 }
                ...
                Rectangle { width: q4.width; height: 52; radius: 10
                    ...
                    Text { anchors.left: parent.left; anchors.leftMargin: 50
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        text: "usertrap() in trap.c handles the cause"; color: "white"; font.pixelSize: 12; font.family: "Segoe UI"; wrapMode: Text.WordWrap }
                ...
                Rectangle { width: q4.width; height: 52; radius: 10
                    ...
                    Text { anchors.left: parent.left; anchors.leftMargin: 50
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        text: "usertrapret() + sret returns to user"; color: "white"; font.pixelSize: 12; font.family: "Segoe UI"; wrapMode: Text.WordWrap }
                ...
                Rectangle { width: q4.width; height: 52; radius: 10
                    ...
                    Text { anchors.left: parent.left; anchors.leftMargin: 50
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        text: "Trap fires (interrupt or exception)"; color: "white"; font.pixelSize: 12; font.family: "Segoe UI"; wrapMode: Text.WordWrap }
            ...
            Column { id: q5
                ...
                width: parent.width; spacing: 8
                Rectangle { width: parent.width; height: 1; color: Qt.rgba(255,255,255,0.07) }
                Text { text: "5.  Interrupts differ from exceptions because interrupts are ___."; color: "white"; font.pixelSize: 13
                    font.family: "Segoe UI"; width: parent.width; wrapMode: Text.WordWrap; lineHeight: 1.45 }
                Repeater { model: ["always fatal", "software-triggered", "asynchronous", "caused by ecall only"]
                    delegate: Rectangle {
        ...
        Rectangle {
            ...
            Text { anchors.centerIn: parent
                text: "←   TRAPS OVERVIEW  (Back to Lesson)"
                color: "#f97316"; font.bold: true; font.pixelSize: 13; font.family: "Segoe UI" }
