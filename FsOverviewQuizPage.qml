...
ScrollView {
    ...
    property string quizName:    "fs_overview_quiz"
    property string lessonSource:"FsOverviewPage.qml"
    ...
    Column {
        ...
        Rectangle {
            ...
            color: Qt.rgba(255,255,255,0.03); border.color: "#84cc16"; border.width: 1
            Column { anchors.centerIn: parent; spacing: 5
                Text { text: "FS OVERVIEW  QUIZ"; color: "#84cc16"
            ...
            Column { id: q1
                ...
                Text { text: "1.  open('/a/b') resolves the path using ___."; color: "white"; font.pixelSize: 13
                    font.family: "Segoe UI"; width: parent.width; wrapMode: Text.WordWrap; lineHeight: 1.45 }
                Repeater { model: ["bread() directly", "namei() walking the directory tree", "Buffer cache LRU list", "iget() only"]
                    delegate: Rectangle {
                        width: q1.width; height: 44; radius: 10
                        ...
                        Text { anchors.centerIn: parent
                            ...
                            color: { if(!q1.submitted)return"white"
                                if(index===q1.correctIndex)return"#10b981"
                                if(index===q1.selectedIndex)return"#ef4444"
                                return Qt.rgba(255,255,255,0.35) }
                            font.pixelSize: 12; font.family: "Segoe UI"
                            font.bold: q1.submitted&&(index===q1.correctIndex||index===q1.selectedIndex)
            ...
            Column{id:q2
                ...
                property bool submitted:scrollRoot.showResults
                property bool isCorrect:m0===1 && m1===3 && m2===2 && m3===0
                property bool answered:m0!==-1&&m1!==-1&&m2!==-1&&m3!==-1
                width:parent.width;spacing:8
                Rectangle{width:parent.width;height:1;color:Qt.rgba(255,255,255,0.07)}
                Text{text:"2.  Match each FS layer to its function:";color:"white";font.pixelSize:13;font.family:"Segoe UI"
                ...
                Rectangle{width:q2.width;radius:10
                    ...
                    Column{id:dc2;anchors.top:parent.top;anchors.left:parent.left
                        ...
                        Text{text:"A.  Maps filename strings to inode numbers";color:Qt.rgba(255,255,255,0.68);font.pixelSize:11;font.family:"Segoe UI";width:parent.width;wrapMode:Text.WordWrap}
                        Text{text:"B.  Caches disk blocks in memory";color:Qt.rgba(255,255,255,0.68);font.pixelSize:11;font.family:"Segoe UI";width:parent.width;wrapMode:Text.WordWrap}
                        Text{text:"C.  Manages file metadata and data blocks";color:Qt.rgba(255,255,255,0.68);font.pixelSize:11;font.family:"Segoe UI";width:parent.width;wrapMode:Text.WordWrap}
                        Text{text:"D.  Provides crash-consistent writes via log";color:Qt.rgba(255,255,255,0.68);font.pixelSize:11;font.family:"Segoe UI";width:parent.width;wrapMode:Text.WordWrap}
                    }}
                Column{width:q2.width;spacing:6
                    ...
                    Rectangle{width:q2.width;height:48;radius:8
                        color:{if(!q2.submitted)return Qt.rgba(255,255,255,0.04)
                            if(q2.m0===1)return Qt.rgba(16,185,129,0.10)
                        ...
                        Text{anchors.left:parent.left;anchors.leftMargin:12;anchors.verticalCenter:parent.verticalCenter
                            width:100;text:"Buffer cache";color:"white";font.pixelSize:12;font.bold:true
                    ...
                    Rectangle{width:q2.width;height:48;radius:8
                        color:{if(!q2.submitted)return Qt.rgba(255,255,255,0.04)
                            if(q2.m1===3)return Qt.rgba(16,185,129,0.10)
                            return Qt.rgba(239,68,68,0.08)}
                        border.color:Qt.rgba(255,255,255,0.08);border.width:1
                        Text{anchors.left:parent.left;anchors.leftMargin:12;anchors.verticalCenter:parent.verticalCenter
                            width:100;text:"Logging";color:"white";font.pixelSize:12;font.bold:true
                            font.family:"Segoe UI";elide:Text.ElideRight}
                        Row{anchors.right:parent.right;anchors.rightMargin:10;anchors.verticalCenter:parent.verticalCenter
                            spacing:8
                    ...
                    Rectangle{width:q2.width;height:48;radius:8
                        color:{if(!q2.submitted)return Qt.rgba(255,255,255,0.04)
                            if(q2.m2===2)return Qt.rgba(16,185,129,0.10)
                            return Qt.rgba(239,68,68,0.08)}
                        border.color:Qt.rgba(255,255,255,0.08);border.width:1
                        Text{anchors.left:parent.left;anchors.leftMargin:12;anchors.verticalCenter:parent.verticalCenter
                            width:100;text:"Inode layer";color:"white";font.pixelSize:12;font.bold:true
                            font.family:"Segoe UI";elide:Text.ElideRight}
                        Row{anchors.right:parent.right;anchors.rightMargin:10;anchors.verticalCenter:parent.verticalCenter
                            spacing:8
                    ...
                    Rectangle{width:q2.width;height:48;radius:8
                        color:{if(!q2.submitted)return Qt.rgba(255,255,255,0.04)
                            if(q2.m3===0)return Qt.rgba(16,185,129,0.10)
                            return Qt.rgba(239,68,68,0.08)}
                        border.color:Qt.rgba(255,255,255,0.08);border.width:1
                        Text{anchors.left:parent.left;anchors.leftMargin:12;anchors.verticalCenter:parent.verticalCenter
                            width:100;text:"Directory layer";color:"white";font.pixelSize:12;font.bold:true
                            font.family:"Segoe UI";elide:Text.ElideRight}
                        Row{anchors.right:parent.right;anchors.rightMargin:10;anchors.verticalCenter:parent.verticalCenter
                            spacing:8
            ...
            Column { id: q3
                property int selectedIndex: -1; property int correctIndex: 0
                property bool submitted: scrollRoot.showResults
                property bool isCorrect: selectedIndex === correctIndex
                property bool answered:  selectedIndex !== -1
                width: parent.width; spacing: 8
                Rectangle { width: parent.width; height: 1; color: Qt.rgba(255,255,255,0.07) }
                Text { text: "3.  Two processes opening the same file share one inode (same inode number)."; color: "white"; font.pixelSize: 13
                    font.family: "Segoe UI"; width: parent.width; wrapMode: Text.WordWrap; lineHeight: 1.45 }
                Row { spacing: 14; width: parent.width
                    Repeater { model: ["True","False"]
                        delegate: Rectangle {
                            width: (q3.width-14)/2; height: 54; radius: 10
                            ...
                            Text { anchors.centerIn: parent; text: index===0?"TRUE":"FALSE"
                                color: { if(!q3.submitted)return q3.selectedIndex===index?"white":Qt.rgba(255,255,255,0.55)
                                    if(index===q3.correctIndex)return"#10b981"
                                    if(index===q3.selectedIndex)return"#ef4444"
            ...
            Column { id: q4
                ...
                property bool submitted: scrollRoot.showResults
                property bool isCorrect: r0===4 && r1===2 && r2===1 && r3===3
                property bool answered: r0>0 && r1>0 && r2>0 && r3>0
                width: parent.width; spacing: 8
                Rectangle { width: parent.width; height: 1; color: Qt.rgba(255,255,255,0.07) }
                Text { text: "4.  Click a file write through the FS layers in order (first → last):"; color: "white"; font.pixelSize: 13
                    font.family: "Segoe UI"; width: parent.width; wrapMode: Text.WordWrap; lineHeight: 1.45 }
                ...
                Rectangle { width: q4.width; height: 52; radius: 10
                    color: { if(!q4.submitted)return q4.r0>0?Qt.rgba(75,42,192,0.28):Qt.rgba(255,255,255,0.05)
                        if(q4.r0===4)return Qt.rgba(16,185,129,0.22)
                    ...
                    Text { anchors.left: parent.left; anchors.leftMargin: 50
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        text: "Data written to final disk location"; color: "white"; font.pixelSize: 12; font.family: "Segoe UI"; wrapMode: Text.WordWrap }
                    Text { id: ht40; anchors.right: parent.right; anchors.rightMargin: 10
                        anchors.verticalCenter: parent.verticalCenter
                        visible: q4.submitted && q4.r0 !== 4
                ...
                Rectangle { width: q4.width; height: 52; radius: 10
                    color: { if(!q4.submitted)return q4.r1>0?Qt.rgba(75,42,192,0.28):Qt.rgba(255,255,255,0.05)
                        if(q4.r1===2)return Qt.rgba(16,185,129,0.22)
                    ...
                    Text { anchors.left: parent.left; anchors.leftMargin: 50
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        text: "log_write() stages the block in memory"; color: "white"; font.pixelSize: 12; font.family: "Segoe UI"; wrapMode: Text.WordWrap }
                    Text { id: ht41; anchors.right: parent.right; anchors.rightMargin: 10
                        anchors.verticalCenter: parent.verticalCenter
                        visible: q4.submitted && q4.r1 !== 2
                ...
                Rectangle { width: q4.width; height: 52; radius: 10
                    color: { if(!q4.submitted)return q4.r2>0?Qt.rgba(75,42,192,0.28):Qt.rgba(255,255,255,0.05)
                        if(q4.r2===1)return Qt.rgba(16,185,129,0.22)
                    ...
                    Text { anchors.left: parent.left; anchors.leftMargin: 50
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        text: "begin_op() starts the transaction"; color: "white"; font.pixelSize: 12; font.family: "Segoe UI"; wrapMode: Text.WordWrap }
                    Text { id: ht42; anchors.right: parent.right; anchors.rightMargin: 10
                        anchors.verticalCenter: parent.verticalCenter
                        visible: q4.submitted && q4.r2 !== 1
                ...
                Rectangle { width: q4.width; height: 52; radius: 10
                    color: { if(!q4.submitted)return q4.r3>0?Qt.rgba(75,42,192,0.28):Qt.rgba(255,255,255,0.05)
                        if(q4.r3===3)return Qt.rgba(16,185,129,0.22)
                    ...
                    Text { anchors.left: parent.left; anchors.leftMargin: 50
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        text: "commit() writes and installs the log"; color: "white"; font.pixelSize: 12; font.family: "Segoe UI"; wrapMode: Text.WordWrap }
                    Text { id: ht43; anchors.right: parent.right; anchors.rightMargin: 10
                        anchors.verticalCenter: parent.verticalCenter
                        visible: q4.submitted && q4.r3 !== 3
            ...
            Column { id: q5
                ...
                width: parent.width; spacing: 8
                Rectangle { width: parent.width; height: 1; color: Qt.rgba(255,255,255,0.07) }
                Text { text: "5.  On reboot after a crash, xv6 restores consistency by ___."; color: "white"; font.pixelSize: 13
                    font.family: "Segoe UI"; width: parent.width; wrapMode: Text.WordWrap; lineHeight: 1.45 }
                Repeater { model: ["Running fsck", "Replaying the log", "Rebuilding the inode table", "Ignoring dirty blocks"]
                    delegate: Rectangle {
        ...
        Rectangle {
            ...
            Text { anchors.centerIn: parent
                text: "←   FS OVERVIEW  (Back to Lesson)"
                color: "#84cc16"; font.bold: true; font.pixelSize: 13; font.family: "Segoe UI" }
