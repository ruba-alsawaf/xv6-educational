    ...
    Column {
            ...
            Row {
                ...
                Rectangle {
                    ...
                    Column {
                        ...
                        Text { text:"07"; color:"#8b5cf6"; font.bold:true; font.pixelSize:20; font.family:"Consolas"; anchors.horizontalCenter:parent.horizontalCenter }
                        Text { text:"LESSON"; color:Qt.rgba(139,92,246,0.5); font.pixelSize:7; font.letterSpacing:1; anchors.horizontalCenter:parent.horizontalCenter }
                    }
                }
                Column {
        ...
        Rectangle {
            ...
            Component.onCompleted: {
                ...
                done = dbManager.isAttended(user, "KernelSpacePage.qml")
            }
            ...
            MouseArea {
                ...
                onClicked: {
                    if (!attendBtn.done) {
                        var user = dbManager.getCurrentUser()
                        dbManager.markAttended(user, "KernelSpacePage.qml")
                        attendBtn.done = true
        ...
        Rectangle {
            ...
            Text {
                ...
                text: "QUIZ  →  KERNEL ADDR SPACE"
                color: attendBtn.done ? "#8b5cf6" : Qt.rgba(255,255,255,0.25); font.bold: true; font.pixelSize: 13
            ...
            MouseArea {
                ...
                onClicked: if (attendBtn.done) scrollRoot.requestNavigate("KernelSpaceQuizPage.qml")
            }
        }
        // ── NEXT LESSON BUTTON ───────────────────────────────────────────
        Rectangle {
            ...
            Row {
                ...
                Text { text: "→  USER SPACE"; color: attendBtn.done ? "#8b5cf6" : Qt.rgba(255,255,255,0.25); font.bold: true; font.pixelSize: 13; font.family: "Segoe UI"; font.letterSpacing: 0.4; anchors.verticalCenter: parent.verticalCenter }
            }
            MouseArea {
                id: nextBtn; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor
                onClicked: scrollRoot.requestNavigate("UserAddressSpacePage.qml")
            }
        }
    }
}
